...
description: 人们总是喜欢炫耀自己的新技能，紫升也不例外，毕竟新技能需要大量的实战练习。在入门了 VS Code 扩展开发后，遇到开发痛点我就习惯地用 VS Code 插件的思路去解决。不过大多扩展 idea 都已经名花有主，直到我想到可以将 yarn.lock 文件可视化并搜索相关插件无果后，我知道机会来了。
...
在 [《从零开发一款基于 webview 的 vscode 扩展》](https://juejin.cn/post/7000589186898231333) 一文中，紫升通过实战阐述了如何基于 webview 实现在 vscode 中展示自定义 UI 的功能，另外文章配套产物 [掘金一下](vscode:extension/youngjuning.juejin-me) 插件也已经发布，欢迎试用。

人们👨🏻‍💻总是喜欢炫耀自己的新技能，紫升也不例外，毕竟新技能需要大量的实战练习。在入门了 VS Code 扩展开发后，遇到开发痛点我就习惯地用 VS Code 插件的思路去解决。不过大多扩展 idea 都已经名花有主，直到我想到可以将 `yarn.lock` 文件可视化并搜索相关插件无果后，我知道机会来了。
...
![紫升](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/301eab5bbab04c65aec4a927b7d306a9~tplv-k3u1fbpfcp-zoom-1.image)
...
![紫升](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/116948b627f4406ba51faa0353f147a7~tplv-k3u1fbpfcp-zoom-1.image)
